...
export default function Sidebar() {
  ...
  return (
    <>
      <header className="sm:hidden fixed top-0 left-0 right-0 bg-white z-50 flex items-center justify-between p-4 shadow-md">
      ...
      {isOpen && (
        <div className="sm:hidden fixed top-16 left-4 right-4 z-40 bg-white shadow-lg rounded-lg p-4">
          <ul className="space-y-2 font-medium">
            ...
            <li>
              <Link to="/consultation" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                <FaUserNurse
            ...
            <li>
              <Link to="/pharmacylocator" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                <AiFillSetting
                  fill="currentColor"
                  size={24}
                  className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900"
            ...
            <li>
              <Link to="/auth/register" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
      ...
      <aside className={`hidden sm:block top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform transform bg-white border-r border-gray-200`} aria-label="Sidebar">
